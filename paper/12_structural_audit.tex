...
%     \item \textbf{Strong CP and Axion Searches:} Because the strong force sector ($\sigma - \chi = 3$) is geometrically orthogonal to the temporal boundary, $\theta_{QCD} \equiv 0$ is the exact, static ground state of the vacuum. This topological prohibition predicts that the neutron electric dipole moment (nEDM) is strictly limited to the electroweak CKM background ($\sim 10^{-32}$ e·cm), and axion searches targeting the standard Peccei-Quinn mechanism will continue to yield null results. This does not exclude axion-like particles (ALPs) arising from independent dark matter phenomenology, but the discovery of a standard QCD axion would invalidate this topological isolation.